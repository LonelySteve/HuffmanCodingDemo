...
namespace HuffmanCodingCore.Exceptions
{
    ...
    {
        public EncodeArgumentException()
        {
        }
    ...
    public class CodeBookKeyNotFoundException : CodeBookException
    {
        ...
        public CodeBookKeyNotFoundException(string keyName) : base(
            $"Cannot find a key value pair with a key value of '{keyName}' in CodeBook!")
        {
        }
    }
}